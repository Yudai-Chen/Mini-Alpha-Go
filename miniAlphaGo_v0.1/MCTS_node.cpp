...
void MCTS_node::printChildDetailScores()
{
	...
	std::cout << "potentialScore： " << potentialScore << std::endl;
	std::cout << "nearbyCountScore： " << nearbyCountScore << std::endl;
	std::cout << "edgeCornerStableScore： " << edgeCornerStableScore << std::endl;
	std::cout << "visit time： " << visitTime << std::endl;
	std::cout << "win rate： " << winTime[!board.whosTurn()] / visitTime << std::endl;
	std::cout << "quality score： " << quality << std::endl;
	std::cout << "win time score： " << 4 * winTime[!board.whosTurn()] / visitTime << std::endl << std::endl;
}
#endif